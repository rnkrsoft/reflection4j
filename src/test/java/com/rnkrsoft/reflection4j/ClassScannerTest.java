...
import com.rnkrsoft.reflection4j.scanner.B;
import com.rnkrsoft.reflection4j.scanner.ann.Ann;
...
public class ClassScannerTest {
    ...
    public void testScan() throws Exception {
        ...
        scanner.scan("com.rnkrsoft.reflection4j.scanner");
    ...
    public void testScan2() throws Exception {
        ...
        scanner.clear();
        scanner.scan("com.rnkrsoft.reflection4j.scanner", new ClassScanner.Filter() {
    ...
    public void testScan3() throws Exception {
        ClassScanner scanner = new ClassScanner(true);
        scanner.scan("com.rnkrsoft.reflection4j.scanner", new ClassScanner.IncludeMethodNameFilter("fun1"));
        Assert.assertEquals(2, scanner.getClasses().size());
        scanner.clear();
        scanner.scan("com.rnkrsoft.reflection4j.scanner", new ClassScanner.IncludeMethodNameFilter("fun2"));
        Assert.assertEquals(2, scanner.getClasses().size());
        scanner.clear();
        scanner.scan("com.rnkrsoft.reflection4j.scanner", new ClassScanner.IsAFilter(B.class));
