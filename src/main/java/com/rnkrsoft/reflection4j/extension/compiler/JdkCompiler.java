...
public class JdkCompiler extends AbstractCompiler {
    ...
    @Override
    public Class<?> doCompile(String name, String sourceCode, File outputPath) throws Throwable {
        ...
        Boolean result = compiler.getTask(new PrintWriter(System.out), javaFileManager, diagnosticCollector, options, null, Arrays.asList(new JavaFileObject[]{javaFileObject})).call();
